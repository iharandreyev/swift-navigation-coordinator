...
struct DeeplinkTests {
  ...
  func appCoordinator_canHandleDeeplink_onlyWhen_main() async throws {
    ...
    sut.addChild(DummyCoordinator().with(processDeeplinkResult: .done), as: AppDestination.appInit)
    sut.addChild(DummyCoordinator().with(processDeeplinkResult: .done), as: AppDestination.onboarding)
    sut.addChild(DummyCoordinator().with(processDeeplinkResult: .done), as: AppDestination.main)
